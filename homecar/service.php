...
?>
			...
			<div class="ovacrs_heading3  text-center"><h3 class="title border_yes"><span>Repair Service</span></h3><div class="desc"><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p></div></div>		</div>
				</div>
						</div>
					</div>
		</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
								<div class="elementor-image">
												<img decoding="async" width="984" height="272" src="../wp-content/uploads/2018/07/repair-service.jpg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://demo.ovatheme.com/ireca/wp-content/uploads/2018/07/repair-service.jpg 984w, https://demo.ovatheme.com/ireca/wp-content/uploads/2018/07/repair-service-300x83.jpg 300w, https://demo.ovatheme.com/ireca/wp-content/uploads/2018/07/repair-service-768x212.jpg 768w, https://demo.ovatheme.com/ireca/wp-content/uploads/2018/07/repair-service-600x166.jpg 600w" sizes="(max-width: 984px) 100vw, 984px" />														</div>
						</div>
				</div>
						</div>
					</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="ireca_service_repair " ><i class="flaticon-price-tag"></i><div class="content"><h3><a target="_self" href="#">AFFORDABLE</a></h3><div class="desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque</div></div></div>		</div>
				</div>
						</div>
					</div>
		</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="ireca_service_repair " ><i class="carflaticon-car-oil"></i><div class="content"><h3><a target="_self" href="#">Oil Changes</a></h3><div class="desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque</div></div></div>		</div>
				</div>
						</div>
					</div>
		</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="ireca_service_repair " ><i class="flaticon-like"></i><div class="content"><h3><a target="_self" href="#">Good quality</a></h3><div class="desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque</div></div></div>		</div>
				</div>
						</div>
					</div>
		</div>
