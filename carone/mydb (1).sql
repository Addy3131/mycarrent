...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2023 at 08:45 AM
...
--
ALTER TABLE `advertisment`
  ADD CONSTRAINT `advertisment_ibfk_1` FOREIGN KEY (`cus_id`) REFERENCES `user` (`cus_id`),
  ADD CONSTRAINT `advertisment_ibfk_2` FOREIGN KEY (`city`) REFERENCES `city` (`city_id`),
  ADD CONSTRAINT `advertisment_ibfk_3` FOREIGN KEY (`area`) REFERENCES `area` (`area_id`),
  ADD CONSTRAINT `advertisment_ibfk_4` FOREIGN KEY (`cat`) REFERENCES `categories` (`cat_id`);
