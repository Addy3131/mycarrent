              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      <label for="Email" class="text-black">licence_no<span class="text-danger">*</span></label>
                      <input type="tel" class="form-control" value=""  name="licence_no">
                    </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
					          <label for="password" class="text-black">Fuel Type <span class="text-danger">*</span></label>
